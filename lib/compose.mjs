...
// The emulator profile must be passed so `stop`/`down` also target the
// profile-gated emulator service (compose ignores profiled services otherwise).
const ALL_PROFILES = ['emulator'];
