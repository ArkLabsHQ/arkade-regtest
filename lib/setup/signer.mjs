...
// none). So: recreate the wallet, let it boot, unlock it, THEN restart arkd so
// it re-fetches the complete set, unlock again, and wait until synced. (Mirrors
// arkd's own e2e recreateArkdWallet.)
